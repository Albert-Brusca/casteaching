<x-casteaching-layout>
    <div class="flex flex-col items-center">
            <iframe
                ...
                style="height: 75vh"
                src="https://www.youtube.com/embed/q06GbMP1h_s"
        ...
        <div class="inline-block w-full max-w-7xl w-5/6 bg-white rounded-lg shadow-lg px-4 py-4 md:px-6 xl:px-15 xl:py-5 2xl:px-20 2xl:py-10 m-4 border-t-2 border-indigo-500 rounded-t-none">
            <h2 class="text-gray-800 uppercase font-bold text-2xl tracking-tight border-b border-gray-300">
                {{ $video->title }}
            </h2>
        ...
        <div class="prose-sm md:prose lg:prose-xl 2xl:prose-2xl mx-auto p-3">
